...
const DICT = {
  it: {
    ...
    "search.button": "Cerca",
    "search.hint": "Filtra gli hotel già salvati (non scarica nulla).",
    "search.results": "Risultati ricerca",
    "scan.title": "Scansiona (aggiungi)",
    "scan.hint": "Trova hotel NUOVI nel mondo e li aggiunge all'archivio.",
    ...
    "archive.capped": "— primi 5000 per voto",
  ...
  en: {
    ...
    "search.hint": "Filters hotels already saved (downloads nothing).",
    "search.results": "Search results",
    "scan.title": "Scan (add new)",
    "scan.hint": "Finds NEW hotels worldwide and adds them.",
    "scan.button": "Scan",
    ...
    "archive.capped": "— top 5000 by score",
